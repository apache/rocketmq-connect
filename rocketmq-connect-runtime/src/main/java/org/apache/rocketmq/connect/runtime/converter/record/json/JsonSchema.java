...
public class JsonSchema {
    ...
    public static final JSONObject BOOLEAN_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, BOOLEAN_TYPE_NAME);
    public static final String INT8_TYPE_NAME = "int8";
    public static final JSONObject INT8_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, INT8_TYPE_NAME);
    public static final String INT16_TYPE_NAME = "int16";
    public static final JSONObject INT16_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, INT16_TYPE_NAME);
    public static final String INT32_TYPE_NAME = "int32";
    public static final JSONObject INT32_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, INT32_TYPE_NAME);
    public static final String INT64_TYPE_NAME = "int64";
    public static final JSONObject INT64_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, INT64_TYPE_NAME);
    public static final String FLOAT_TYPE_NAME = "float";
    public static final JSONObject FLOAT_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, FLOAT_TYPE_NAME);
    public static final String DOUBLE_TYPE_NAME = "double";
    public static final JSONObject DOUBLE_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, DOUBLE_TYPE_NAME);
    public static final String BYTES_TYPE_NAME = "bytes";
    public static final JSONObject BYTES_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, BYTES_TYPE_NAME);
    public static final String STRING_TYPE_NAME = "string";
    public static final JSONObject STRING_SCHEMA = newJSONObject(SCHEMA_TYPE_FIELD_NAME, STRING_TYPE_NAME);
