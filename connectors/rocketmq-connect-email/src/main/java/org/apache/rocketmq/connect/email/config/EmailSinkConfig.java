...
package org.apache.rocketmq.connect.email.config;
...
public class EmailSinkConfig {
    public static final Set<String> SINK_REQUEST_CONFIG = new HashSet<String>() {
        {
            add(EmailConstants.EMAIL_FROM_ADDRESS);
            add(EmailConstants.EMAIL_TO_ADDRESS);
            add(EmailConstants.EMAIL_HOST);
            add(EmailConstants.EMAIL_PASSWORD);
            add(EmailConstants.EMAIL_SUBJECT);
            add(EmailConstants.EMAIL_CONTENT);
            add(EmailConstants.EMAIL_TRANSPORT_PROTOCOL);
            add(EmailConstants.EMAIL_SMTP_AUTH);
        }
    };
