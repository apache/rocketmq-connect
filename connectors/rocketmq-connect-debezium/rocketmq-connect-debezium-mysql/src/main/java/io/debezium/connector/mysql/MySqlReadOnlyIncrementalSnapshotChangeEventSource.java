...
public class MySqlReadOnlyIncrementalSnapshotChangeEventSource<T extends DataCollectionId> extends AbstractIncrementalSnapshotChangeEventSource<T> {
    ...
    private final RocketMqSignalThread<T> rocketMQSignal;
    ...
    public MySqlReadOnlyIncrementalSnapshotChangeEventSource(RelationalDatabaseConnectorConfig config, JdbcConnection jdbcConnection,
        ...
        rocketMQSignal = new RocketMqSignalThread<>(MySqlConnector.class, config, this);
    }
    ...
    public void init(OffsetContext offsetContext) {
        ...
        if (signalOffset != null) {
            rocketMQSignal.seek(signalOffset);
        }
        rocketMQSignal.start();
    }
    ...
    private void addDataCollectionNamesToSnapshot(ExecuteSnapshotRocketMqSignal executeSnapshotSignal, OffsetContext offsetContext) throws InterruptedException {
